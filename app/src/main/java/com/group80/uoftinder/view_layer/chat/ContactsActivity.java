...
import com.group80.uoftinder.interface_adapter_layer.chat.ContactPresenter;
import com.group80.uoftinder.interface_adapter_layer.chat.ContactsViewInterface;
import com.group80.uoftinder.view_layer.feed.RecommendationView;

/**
 * A window that displays all the contacts to chat with
 */
public class ContactsActivity extends AppCompatActivity implements ContactsViewInterface {
