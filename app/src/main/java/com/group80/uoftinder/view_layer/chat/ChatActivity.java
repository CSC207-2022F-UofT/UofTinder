...
import com.group80.uoftinder.interface_adapter_layer.chat.ChatViewInterface;
...
import com.group80.uoftinder.interface_adapter_layer.chat.ChatPresenter;
...
public class ChatActivity extends AppCompatActivity implements ChatViewInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String chatRoom = ChatViewInterface.getChatRoom(FirebaseAuth.getInstance().getCurrentUser().getUid(), contactUid);
